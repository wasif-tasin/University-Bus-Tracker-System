...
void AdminLoginGUI::run()
{
    ...
    TextBox userBox(font, {fW, FIELD_H}, {fX, cY + Y_FIELD1});
    ...
    while (window.isOpen())
    {
        userBox.setFocused(focus == F_USER);
        ...
        while (const std::optional event = window.pollEvent())
        {
            ...
            if (event->is<sf::Event::MouseButtonPressed>())
            {
                ...
                if (userBox.getBounds().contains({mx, my})) { focus = F_USER; }
            ...
            if (event->is<sf::Event::TextEntered>() ||
                ...
                if      (focus == F_USER) userBox.handleEvent(*event);
        ...
        Theme::drawBackdrop(window, ww, wh, Theme::PURPLE, Theme::PURPLE_PINK);
        ...
        Theme::drawTextHCentered(window, font, "Admin Login", Theme::Type::TITLE,
                                 ...
                                 sf::Text::Bold);
        Theme::drawTextHCentered(window, font, "Restricted area - staff credentials required",
        ...
        drawLabel("USERNAME", Y_LABEL1, focus == F_USER);
